...
\label{subsec:scope}
This research contributes empirical evidence on carbon market integration with rural electrification, advancing understanding of how market-based mechanisms can address development financing challenges. The findings inform policy frameworks for carbon market regulation, rural electrification strategies, and actionable insights for developers, investors, and policy makers navigating post-Paris governance complexity. The contributions of this paper are as follows:
\begin{enumerate}
    \item We provide the first empirical evidence that carbon finance transaction costs systematically exceed potential revenues for sub-200-kWp mini-grids in sub-Saharan Africa, with certification costs representing approximately 8--10\% of capital expenditure at current voluntary carbon market prices of 1--5 USD per \tcooe.
    \item We demonstrate that aggregation mechanisms do not emerge organically from market forces, evidenced by the non-replication of the atmosfair-MiniGridCo model across 200+ Nigerian mini-grids despite technical feasibility and available Programme of Activities (PoA) frameworks.
    \item We identify five interdependent condition clusters required for successful carbon market integration: technical capacity, financial viability, regulatory frameworks, institutional arrangements, and carbon market design. We also identify the coordinated public interventions each domain requires.
\end{enumerate}
For developers, this research provides insights on project design and financing structures that enhance commercial viability through carbon market participation.
...
The remainder of this paper is structured as follows. Section~\ref{sec:lit-review} reviews the literature on carbon market governance, environmental integrity risks, and mini-grid financing experience in SSA. Section~\ref{sec:concept} presents the conceptual framework linking energy poverty, mini-grids, carbon markets, and policy. Section~\ref{sec:methods} describes the research design, site selection, and data collection and analysis procedures. Section~\ref{sec:results} presents and discusses findings for each research question. Section~\ref{sec:conc} concludes with theoretical and policy implications, practice recommendations, and directions for future research.